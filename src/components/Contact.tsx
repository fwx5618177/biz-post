      ...
      <div className="container contact__container">
        <div className="contact__content">
          <h2 className="contact__title">
            Let's <span>Connect</span> and Discuss Your Project
          </h2>
          <p className="contact__description">
            Ready to transform your digital presence? Get in touch with our team to discuss your project requirements and how we can help you achieve your goals.
          </p>
          ...
          <div className="contact__info">
            ...
            <div className="contact__info-item">
              ...
              <div className="contact__info-item-content">
                <h4>Email Address</h4>
                <a href="mailto:info@moxxidesign.com">info@moxxidesign.com</a>
              </div>
            </div>
